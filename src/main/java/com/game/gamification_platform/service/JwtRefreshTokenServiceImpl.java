...
import com.game.gamification_platform.repository.JwtRefreshTokenRepository;
...
import com.game.gamification_platform.security.jwt.JwtProvider;
...
public class JwtRefreshTokenServiceImpl implements JwtRefreshTokenService{
    ...
    public JwtRefreshToken createRefreshToken(Long userId) {
        ...
        jwtRefreshToken.setExpirationDate(LocalDateTime.now()
                .plus(REFRESH_EXPIRATION_IN_MS, ChronoUnit.MILLIS));
